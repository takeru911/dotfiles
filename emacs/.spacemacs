...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; `trailing' to delete only the whitespacle at end of lines, `changed' to
